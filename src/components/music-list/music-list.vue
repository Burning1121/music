<template>
  <div class="music-list">
    ...
    <h1 class="title" ref="musicListTitle" v-html="title"></h1>
    <div class="bg-image" :style="bgStyle" ref="bgImage">
      <div class="play-wrapper" v-show="songs.length>0" ref="playBtn">
        <div class="play" @click="randomItem">
          <i class="icon-play"></i>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    mounted() {
      this.titleHeight = parseInt(this.$refs.musicListTitle.clientHeight)
      this.bgImageHeight = this.$refs.bgImage.clientHeight
      this.minTranslateY = -this.bgImageHeight + this.titleHeight
