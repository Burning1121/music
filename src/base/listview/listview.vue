<template>
  <scroll :data="data" :probeType="probeType" class="listview" ref="listview" :listenScroll="listenScroll"
          @scroll="scroll">
    <ul>
  ...
  export default {
    ...
    methods: {
      ...
      onShortCutTouchMove(e) {
        ...
        let height = this.$refs.listShortcutItem[0].clientHeight
